...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div id="jsToPhP" style="display: hide;"></div>
    ...
    <script type="text/javascript">
      ...
      function zoom(event) {
        ...
        var numberImages = 75;
        scale = Math.min(Math.max(0, scale), numberImages);
        if (scale % 1 == 0){
          if(scale < 10){
            x = "0" + scale;
          }else{
          ...
          document.getElementById("Main-Image").src = "images/test1/frame_" + x + "_delay-0.01s.jpg";
          document.cookie="profile_viewer_uid='images/test1/frame_" + x + "_delay-0.01s.jpg'";
        }
      }
