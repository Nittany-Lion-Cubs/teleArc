...
<html lang="en" dir="ltr">
  ...
  <head>
    ...
    .image{
      ...
      margin-left: auto;
      margin-right: auto;
      padding: 1.4% 2.5% 3.6% 2.5%;
      background-color: grey;
      background-image: url(<?php echo $_SESSION['currentImage'];?>);
      background-size: 100%;
  ...
  <body>
    ...
    <div id="Top-Container">
      ...
      <!-- Main Picture -->
      <div id="Image-Area" style="background-color: grey;">
        <div class="image" id="MainImage"></div>
      </div>
    ...
    <!-- The main javaScript for the Zoom function -->
    ...
    function zoom(event) {
      ...
      scale += event.deltaY * 0.25;
      // Set numberImages equal to the images available in the folder
      var numberImages = 300;
      scale = Math.min(Math.max(10, scale), numberImages);
      if (scale % 1 == 0){
        if(scale < 10){
          x = "0" + scale;
        }else{
        ...
        document.getElementById("MainImage").style.backgroundSize = 90+x + "%";
      }
    }
